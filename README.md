...
![Build](https://github.com/JustAnotherID/botgo/actions/workflows/build.yml/badge.svg)
[![Go Reference](https://pkg.go.dev/badge/github.com/JustAnotherID/botgo.svg)](https://pkg.go.dev/github.com/JustAnotherID/botgo)
[![Examples](https://img.shields.io/badge/BotGo-examples-yellowgreen)](https://github.com/JustAnotherID/botgo/tree/master/examples)
...
另外，也有其他同事基于 etcd 实现了 shard 集群的管理，在 [botgo-plugns](https://github.com/JustAnotherID/botgo-plugins) 中。
