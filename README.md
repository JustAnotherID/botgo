...
![Build](https://github.com/sealdice/botgo/actions/workflows/build.yml/badge.svg)
...
另外，也有其他同事基于 etcd 实现了 shard 集群的管理，在 [botgo-plugns](https://github.com/sealdice/botgo-plugins) 中。
